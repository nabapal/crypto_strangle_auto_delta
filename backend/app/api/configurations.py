...
def _serialize_config(config: TradingConfiguration) -> TradingConfigResponse:
    payload = {
        ...
        "strike_selection_mode": config.strike_selection_mode or "delta",
        "call_option_price_min": cast(float | None, config.call_option_price_min),
        "call_option_price_max": cast(float | None, config.call_option_price_max),
        "put_option_price_min": cast(float | None, config.put_option_price_min),
        "put_option_price_max": cast(float | None, config.put_option_price_max),
